...
PVOID NTAPI RtlAllocateHeap(HANDLE HeapPtr, ULONG Flags, SIZE_T Size);
BOOL NTAPI RtlFreeHeap(HANDLE HeapPtr, ULONG Flags, PVOID Ptr);
...
NTSTATUS NTAPI LdrLockLoaderLock(
	ULONG Flags,
	PULONG_PTR Disposition,
	PULONG_PTR Cookie
);

NTSTATUS NTAPI LdrUnlockLoaderLock(
	ULONG Flags,
	ULONG Cookie OPTIONAL
);
